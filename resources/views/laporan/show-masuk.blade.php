            ...
            <div class="row">
                <div class="col-md-12 mb-0">
                    <div class="card py-2">
                        <nav class="nav nav-pills d-flex justify-content-center">
                            <a class="text-sm-center btn btn-outline-success mx-lg-4 active"
                               href="{{route('laporan.masuk.show',['jenis'=>$jenis->id])}}">Pemasukan</a>
                            <a class="text-sm-center btn btn-outline-primary nav-link mx-lg-4"
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-inline mb-3" action="{{route('laporan.masuk.filter',['jenis'=>$jenis->id])}}"
                                  method="GET">
                                {{--                                @csrf--}}
