                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right ">
                                ...
                                <li class="active">Edit Pemasukan Barang ZIS</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <strong>Edit Pemasukan Barang ZIS</strong>
                        </div>
                        <div class="card-body card-block">
                            <form method="POST" action="{{route('pemasukan-bentuk.update',['pemasukan_bentuk'=>$pemasukan->id])}}" enctype="multipart/form-data">
                                @method('PATCH')
                                @csrf
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="bentuk_id" class="custom-select" required>
                                            @foreach( $bentukzis as $data )
                                                @if($data->jenis == $pemasukan->bentukzis->bentuk)
                                                    <option selected value="{{$pemasukan->bentukzis->id}}">{{$pemasukan->bentukzis->bentuk}}</option>
                                                @else
