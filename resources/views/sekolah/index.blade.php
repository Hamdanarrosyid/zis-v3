                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="jenjang_sekolah" class="col-sm-4 col-form-label">Jenjang Sekolah</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="nama_sekolah" class="col-sm-4 col-form-label">Nama Sekolah</label>
                            <div class="col-sm-8">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form action="{{route('sekolah.update',['sekolah'=>$data->id])}}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <label for="nama_dasa_wisma" class="col-sm-4 col-form-label">Jenjang Sekolah</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="jumlah_krt" class="col-sm-4 col-form-label">Nama Sekolah</label>
                                <div class="col-sm-8">
