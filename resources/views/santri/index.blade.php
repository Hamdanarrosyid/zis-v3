        ...
        <div class="animated fadeIn">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{route('santri.create')}}" class="badge badge-primary ">
    ...
    <div class="modal fade" id="modal-delete-{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="deleteform" method="POST" action="{{route('santri.destroy',['santri'=>$data->id])}}">
                    @csrf
                    @method('DELETE')
