...
{{--                        </tbody>--}}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="status_warga" class="col-sm-4 col-form-label">Status Warga</label>
                            <div class="col-sm-8">
                                <input type="text" name="status_warga"
    ...
    @foreach($warga as $data)
        <div class="modal fade" id="editmodal-{{$data->id}}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form action="{{route('warga.update',['warga'=>$data->id])}}" method="post">
                        @csrf
                        @method('PATCH')
                        <div class="modal-header d-flex justify-content-between">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <label for="status_warga" class="col-sm-4 col-form-label">Status Warga</label>
                                <div class="col-sm-8">
                                    <input value="{{$data->status_warga}}" type="text" name="status_warga"
                                           class="form-control @error('status_warga') is-invalid @enderror"
                                           id="Warga"
                                           placeholder="Status warga">
                                    @error('status_warga')
    ...
    <div class="modal fade" id="modal-delete-{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="deleteform" method="POST" action="{{route('warga.destroy',['warga'=>$data->id])}}">
                    @csrf
                    @method('DELETE')
