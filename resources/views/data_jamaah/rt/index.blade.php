...
{{--                        </tbody>--}}
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="nomor_rt" class="col-sm-4 col-form-label">Nomor RT</label>
                            <div class="col-sm-8">
                                <input type="number" min="0" name="nomor_rt"
    ...
    @foreach($RT as $data)
        <div class="modal fade" id="editmodal-{{$data->id}}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form action="{{route('RT.update',['RT'=>$data->id])}}" method="post">
                        @csrf
                        @method('PATCH')
                        <div class="modal-header d-flex justify-content-between">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <label for="nomor_rt" class="col-sm-4 col-form-label">Nama RT</label>
                                <div class="col-sm-8">
                                    <input value="{{$data->nomor_rt}}" type="number" min="0" name="nomor_rt"
                                           class="form-control @error('nomor_rt') is-invalid @enderror"
                                           id="RT"
                                           placeholder="Nomor RT">
                                    @error('nomor_rt')
    ...
    <div class="modal fade" id="modal-delete-{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="deleteform" method="POST" action="{{route('RT.destroy',['RT'=>$data->id])}}">
                    @csrf
                    @method('DELETE')
